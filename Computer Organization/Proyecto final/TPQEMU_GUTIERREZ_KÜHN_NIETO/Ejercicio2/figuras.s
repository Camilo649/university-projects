...
/*
	Dibuja un cielo oscureciendo con un degrade en la pantalla
	Parametros: 
		x0 = posicion inicial en x
		x1 = posicion inicial en y
		x2 = ancho
		x3 = largo
		x4 = color base
		x13 = radio del circulo de la nave
*/
...
Cielo_anochecer:
		...
		mov x2, x21
		mov x3, x24
		movz x4, N_SKY_INIT1, lsl #16 
		movk x4, N_SKY_INIT2, lsl #00
		mov x5, #4
		mov x6, #1
		BL Rectangulo_degrades_violeta //Dibuja el "cielo"
		...
		movz x4, LITTLE_SUN_1, lsl #16
		movk x4, LITTLE_SUN_2, lsl #00
		movz x5, CONTORNO_BIG_SOL_SUNSET_1, lsl #16
		movk x5, CONTORNO_BIG_SOL_SUNSET_2, lsl #00
		movz x6, BIG_SUN_SUNSET_1, lsl #16
		movk x6, BIG_SUN_SUNSET_2, lsl #00
		bl Sol //Dibuja los soles
...
/*
	Pinta el fondo puede ser nocturno (x25 = 0), diurno (x25 = 1)
	Parametro:
		x25 = decide si es nocturno o diurno
*/
