...
def connect_to_server(server_name):
    ...
    my_socket.connect((server_name, HTTPS_PORT))
    # Aqui deben conectarse al puerto correcto del servidor
    ssl_context = ssl.SSLContext(protocol=ssl.PROTOCOL_TLS)
    # Crea un contexto SSL para el socket
    return ssl_context.wrap_socket(sock=my_socket)
    #Devuelve una instancia del socket envuelto
