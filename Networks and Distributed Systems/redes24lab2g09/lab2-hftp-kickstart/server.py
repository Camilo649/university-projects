...
class Server(object):
    ...
    def serve(self):
        ...
        while True:
            ...
            # Devuelve una tupla que contiene un nuevo objeto de socket que representa la conexión entrante.
            # y una tupla que contiene la dirección IP y el número de puerto del cliente que inicio la conexión.
