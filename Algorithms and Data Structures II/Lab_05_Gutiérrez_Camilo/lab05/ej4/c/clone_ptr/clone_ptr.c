...
char *string_clone(const char *str, size_t length) {
    char *clone=calloc(sizeof(char), length + 1);
    char *output=clone;
...
/*
    El error en la implementación de la función clone() es que está mal pedida la memoria para la cadena.

    Originalmente, la función se llamaba con length == 3.
*/