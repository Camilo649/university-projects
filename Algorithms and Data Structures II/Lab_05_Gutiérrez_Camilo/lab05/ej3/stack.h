...
/*
    ACLARACIÓN: Para las siguientes funciones, tomo el "tope" de la pila como el último elemento del arreglo.
*/
...
/**
* @brief Create a copy of stack s
* @param s A stack
* @note It will not always be an exact copy because this new array will have the same capacity as the number of elements.
* @return A copy of stack s
*/
