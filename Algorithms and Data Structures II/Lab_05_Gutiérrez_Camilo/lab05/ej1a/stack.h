...
/*
    ACLARACIÓN: Para las siguientes funciones, tomo el "tope" de la pila como el primer elemento de la lista.
    Esto para que se pueda acceder de manera mas barata a la cima que es con lo que más se va a trabajar.
*/
