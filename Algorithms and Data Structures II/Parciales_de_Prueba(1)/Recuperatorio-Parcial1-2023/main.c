...
int main(int argc, char *argv[]) {
    ...
    has_to_discard_wagons(array, trainSize) ?
    printf("Ojo que hay que descartar vagones.\n") :
    printf("Todo bien, no hay que descartar vagones.\n");

    return (EXIT_SUCCESS);
}

/*
    Los archivos "example_easy_nodiscard.in" y "example_discard_2.in" sin modificar, 
    no superan la prueba de que la suma de los pesos de los vagones sea igual a la 
    cantidad total anunciada en la primera línea.
*/