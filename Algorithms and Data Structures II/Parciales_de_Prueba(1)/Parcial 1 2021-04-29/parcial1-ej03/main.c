...
int main(int argc, char *argv[]) {
    ...
    unsigned int sorted_pos = array_sorted_until(movielist, length);
    sorted_pos == (length - 1) ? printf("Movielist is sorted.\n") : printf("Movielist is sorted until %d.", sorted_pos);
